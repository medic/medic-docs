...
#### Step 6: Edit App Name, Server Url, Username and Password
...
The default user for the `medic-collect app` on every instance is usually `collect`. So make sure you have created that user and assigned them a password.


#### Step 7: Run `Build` on Android Studio
